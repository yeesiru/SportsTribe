...
class ProfilePictureService {
  ...
  static final ImagePicker _picker = ImagePicker();  // Show image source selection dialog
  static Future<void> showImageSourceDialog(BuildContext context, {VoidCallback? onSuccess}) async {
    return showDialog(
      context: context,
          ...
          children: [
            ListTile(
              ...
              onTap: () {
                ...
                _pickAndUploadImage(ImageSource.camera, context, onSuccess: onSuccess);
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                _pickAndUploadImage(ImageSource.gallery, context, onSuccess: onSuccess);
              },
            ),
  ...
  static Future<void> _pickAndUploadImage(ImageSource source, BuildContext context, {VoidCallback? onSuccess}) async {
    try {
  ...
  static Future<void> _updateUserProfilePicture(String downloadUrl) async {
    ...
    await user.updatePhotoURL(downloadUrl).timeout(
      Duration(seconds: 30),
      onTimeout: () {
        print('Firebase Auth profile update timed out, but Firestore was updated');
  ...
  static Future<void> _removeProfilePicture(BuildContext context, {VoidCallback? onSuccess}) async {
  ...
  static Future<void> _setDefaultProfilePicture(BuildContext context, {VoidCallback? onSuccess}) async {
    NavigatorState? navigator = Navigator.of(context);
    ScaffoldMessengerState? scaffoldMessenger;
